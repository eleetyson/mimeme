...
m3 = Meme.create(name: "White Guy Blinking", description: "The man in this meme is video producer Drew Scanlon. In 2013, he was working for a video game review website and his now-famous reaction to a co-worker's comment during a live stream was captured on camera. It wasn't until early 2017 when, inexplicably, mainstream Twitter swept up and immortalized his fluttering eyelids. This meme is commonly used to convey confusion, dismay, or surprise.")
...
m4 = Meme.create(name: "Crying Jordan", description: "The star of this meme is NBA legend Michael Jordan, overcome with emotion during his 2009 Hall of Fame induction ceremony. Despite being taken at a moment of triumph, the image is most frequently used to mock disappointment or misfortune.")
c5 = Comment.create(content: "This was my Halloween costume last year :'(", meme_id: 4)

m5 = Meme.create(name: "Doge", description: "The subject of this meme is a Shiba Inu named Kabosu, adopted by a Japanese schoolteacher in 2008. Kabosu's owner overlaid a picture of her with some Comic Sans font in 2010, and the internet went to work. The meme has since been referenced by members of the US Congress and also spawned a cryptocurrency, the Dogecoin.")
c6 = Comment.create(content: "The internet loves cute dogs and that will never change :)", meme_id: 5)

m6 = Meme.create(name: "Success Kid", description: "This meme is of photographer Laney Griner's son, Sam, after he apparently tried to eat some sand. When she uploaded the image to Flickr in 2007, it quickly became fodder for self-congratulatory depictions. While Griner has licensed this picture to multiple advertisers, she also used it to raise money for a 2015 GoFundMe campaign to finance her husband's kidney transplant.")
...
m8 = Meme.create(name: "Roll Safe", description: "The subject of this meme is Reece Simpson, a character on the British TV series #HoodDocumentary, played by Kayode Ewumi. Simpson (aka 'Roll Safe') is often used to illustrate flawed thinking and decision-making.")
